    ...
    public class BaseViewModel : INotifyPropertyChanged
    {
        ...
        public BaseViewModel()
        {
            AddCommand = new Command(() =>
            {
                ...
                if (desc != null)
                {
                    DependencyService.Get<IAppHandler>().LaunchApp("mailto:" + desc.Email);
                }
                else
                {
                    DependencyService.Get<IMessage>().ShortAlert("Impossible d'envoyer de mail, l'adresse mail est incorrecte");
                }
